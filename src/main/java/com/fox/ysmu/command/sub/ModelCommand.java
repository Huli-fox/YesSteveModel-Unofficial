...
public class ModelCommand extends CommandBase {
        ...
        try {
            switch (subCommand) {
                ...
                case "set":
                    ...
                    if (targets.isEmpty()) {
                        sender.addChatMessage(new ChatComponentTranslation("commands.yes_steve_model.model.set.no_targets"));
                        return;
                    }
                ...
                case "export":
                    ...
                    break;
                default:
                    sender.addChatMessage(new ChatComponentTranslation("commands.yes_steve_model.model.invalid_subcommand"));
                    break;
            }
        } catch (Exception e) {
    ...
    private void setModel(ICommandSender sender, List<EntityPlayerMP> targets, String modelName, String textureName, boolean ignoreAuth) {
    ...
    private void reloadAllPack(ICommandSender sender) {
        ...
        watch.stop();
        sender.addChatMessage(new ChatComponentTranslation("message.yes_steve_model.model.reload.info", watch.getTime(TimeUnit.MICROSECONDS) / 1000.0));
    }
